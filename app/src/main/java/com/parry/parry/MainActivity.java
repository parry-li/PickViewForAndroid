...
import com.parry.pickerview.listener.OnOptionsSelectChangeListener;
import com.parry.pickerview.listener.OnOptionsSelectListener;
import com.parry.pickerview.listener.OnTimeSelectChangeListener;
...
import com.parry.parry.bean.CardBean;
import com.parry.parry.bean.ProvinceBean;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initTimePicker() {//Dialog 模式下，在底部弹出
        ...
        if (mDialog != null) {
            ...
            if (dialogWindow != null) {
                dialogWindow.setWindowAnimations(com.parry.pickerview.R.style.picker_view_slide_anim);//修改动画样式
    ...
    private void initCustomTimePicker() {
        ...
        startDate.set(2014, 1, 23);
        Calendar endDate = Calendar.getInstance();
//        endDate.set(2021, 2, 15,14,12,14);
        //时间选择器 ，自定义布局
